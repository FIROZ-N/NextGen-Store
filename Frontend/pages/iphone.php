...
$category = 'iphone'; // Adjusted to AirPods
...
<head>
    ...
    <title>iphone - NextGen Store</title>
...
<body>
    ...
    <?php else: ?>
        <p style="text-align: center;">No iphones available.</p>
    <?php endif; ?>
    <br>
    <br>
    ...
    <br>
    <center>
        <a class="linkkk" href="../pages/iphone.php">Go to Store!</a>
    </center>
    <br>
