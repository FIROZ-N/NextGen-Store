...
$category = 'wireless_headphone'; // Adjusted to AirPods
...
<head>
    ...
    <title>WiredHeadphones - NextGen Store</title>
...
<body>
    ...
    <?php else: ?>
        <p style="text-align: center;">No Productss available.</p>
    <?php endif; ?>
    <br>
    <br>
    ...
    <?php if (empty($products)): ?>
        <p style="text-align: center;">No Product's available.</p>
    <?php else: ?>
        <div class="products">
            <?php foreach ($products as $product): ?>
    ...
    <br>
    <center>
        <a class="linkkk" href="../pages/wireless.php">Go to Store!</a>
    </center>
    <br>
