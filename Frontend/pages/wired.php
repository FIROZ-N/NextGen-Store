...
$category = 'wired_headphone'; // Adjusted to Wired Headphones
...
<head>
    ...
    <title>Wired Headphones - NextGen Store</title>
...
<body>
    ...
    <?php else: ?>
        <p style="text-align: center;">No Wired Headphones available.</p>
    <?php endif; ?>
    <br>
    <br>
    ...
    <br>
    <center>
        <a class="linkkk" href="../pages/wired.php">Go to Store!</a>
    </center>
    <br>
