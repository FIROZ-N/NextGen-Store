...
$category = 'samsung'; // Adjusted to AirPods
...
<head>
    ...
    <title>Samsung - NextGen Store</title>
...
<body>
    ...
    <?php else: ?>
        <p style="text-align: center;">No Mobiles available.</p>
    <?php endif; ?>
    <br>
    <br>
    ...
    <br>
    <center>
        <a class="linkkk" href="../pages/samsung.php">Go to Store!</a>
    </center>
    <br>
